...
HD_PWD='C:/Projects/FPGA/priority_encoder/priority_encoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log priority_enc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source priority_enc.tcl
