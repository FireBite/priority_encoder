...
HD_PWD='C:/Projects/FPGA/priority_encoder/priority_encoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log priority_enc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source priority_enc.tcl -notrace
